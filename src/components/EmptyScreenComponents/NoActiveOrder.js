...
const NoActiveOrder = () => {
  return (
    <View style={styles.mainContainer}>
       <View style={{}}>
           <Image source={require('../../assets/EmptyScreensImages/NoActiveOrders.png')} style={styles.images}/>
       </View>
       <View style={{justifyContent:"center",alignItems:"center",padding:30,}}>
         <Text style={[GlobleStyle.CustomFont, styles.headingText]}>No active orders </Text>
       ...
       <View style={styles.BtnMain}>
          <TouchableOpacity>
            <View style={[styles.BtnContainer, {backgroundColor:"#33FFC2"}]}>
              <Text style={[styles.BtnText, GlobleStyle.CustomHeadingColor, GlobleStyle.CustomFont]}>Continue shopping </Text>
            </View>
          </TouchableOpacity>
        </View>
    </View>
